...
def visualizar_nota_fiscal(id_nota_fiscal):
    ...
    current_app.logger.info("Acessando página de visualização da nota fiscal")

    nota_fiscal = NotaFiscal.query.get_or_404(id_nota_fiscal)
    current_app.logger.info(f"Informações da nota fiscal obtida: {nota_fiscal.id_nota_fiscal}")
