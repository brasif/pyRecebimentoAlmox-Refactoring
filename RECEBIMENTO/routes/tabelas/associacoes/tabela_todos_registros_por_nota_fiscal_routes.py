...
def tabela_todos_registros_por_nota_fiscal(id_nota_fiscal):
    ...
    # Verifica se o id da nota fiscal passado como parametro, existe no banco de dados
    ...
    # Consulta para trazer todos os registros vinculados ao id_nota_fiscal e ordenados pelo id do resgistro
