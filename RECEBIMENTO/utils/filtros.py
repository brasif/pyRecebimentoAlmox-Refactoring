...
def registros_atuais_filtro(model_nf, model_reg, model_resp, query, mes, chave_acesso, nota_fiscal, filial, centro, status, prioridade, responsavel, data_recebimento, data_guarda):
...
def registros_atuais_por_responsavel_e_filial_filtro(model_nf, model_reg, query, mes, chave_acesso, nota_fiscal, centro, status, prioridade, data_recebimento, data_guarda):
...
def todos_registros_por_filial_filtro(model_nf, model_reg, model_resp, query, mes, chave_acesso, nota_fiscal, centro, status, prioridade, responsavel, data_recebimento, data_guarda):
